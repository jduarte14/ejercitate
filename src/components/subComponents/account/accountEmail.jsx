...
const AccountEmail = ({ handleUserModal, setUserEmail, userEmail, patchData }) => {
    ...
    return (
        <Modal visible={true} animationType='slide'>
            <View style={styles.container}>
                ...
                />
                {
                    prevEmail != '' ? <Text style={styles.text}>
                        {
                            prevEmail === userEmail && prevEmail.includes('@') ? "Emails are matching" : "Emails are not matching"
                        }
                    </Text> : null
                }
